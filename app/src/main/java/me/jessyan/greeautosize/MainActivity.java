 ...
 */
package me.jessyan.greeautosize;
 ...
 * 如果想更改为全局以屏幕高度为基准进行适配, 请在 {@link me.jessyan.greeautosize.BaseApplication} 中按注释中更改, 为什么强调全局？
 * 因为 AndroidAutoSize 允许每个 {@link Activity} 可以自定义适配参数, 自定义适配参数通过实现 {@link CustomAdapt}
 * 如果不自定义适配参数就会使用全局的适配参数, 全局适配参数在 {@link me.jessyan.greeautosize.BaseApplication} 中按注释设置
 * <p>
...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * 跳转到 {@link me.jessyan.greeautosize.CustomAdaptActivity}, 展示项目内部的 {@link Activity} 自定义适配参数的用法
     *
     * @param view {@link View}
     */
...
//    //关于旋转的优化处理  jason 优化旋转
//    @Override
//    public Resources getResources() {
//        if (Looper.getMainLooper().getThread() == Thread.currentThread())
//            AutoSizeCompat.autoConvertDensity(
//                    super.getResources(), 1024f, AutoSizeConfig.getInstance().getScreenWidth() > AutoSizeConfig.getInstance().getScreenHeight()
//            );
...
//            AutoSize.autoConvertDensity(this, 1024f, true);
//        }
//    }
}
